...
# run unit test
test: clean
	g++ -o test.o tests/FileWriterTest.cpp && ./test.o
	g++ -o test.o tests/FileReaderTest.cpp && ./test.o
	g++ -o test.o tests/FolderScannerTest.cpp && ./test.o
	g++ -o test.o tests/INIReaderTest.cpp && ./test.o
	g++ -o test.o tests/HtmlFileTest.cpp && ./test.o
	g++ -o test.o tests/CssFileTest.cpp && ./test.o
	g++ -o test.o tests/ResponseTest.cpp && ./test.o
	g++ -o test.o tests/RequestTest.cpp && ./test.o
	g++ -o test.o tests/ResponseBuilderTest.cpp && ./test.o
	# this redirect stderr is only for remove warnings from terminal
	g++ -o test.o tests/ProgramTest.cpp 2> /dev/null && ./test.o
